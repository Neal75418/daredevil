...
- 自選股卡片可能整張空白——零規則觸發時連 `daily_analysis` 都不寫，趨勢／支撐壓力
  一起遺失，畫面上「今日沒訊號」與「壞掉」長得一樣（實測 2059 川湖連續四天）。
  自選股改為即使零訊號也留下分析列（全市場不開放：候選是全市場可分析股票）
- 同一張卡片左側趨勢箭頭與右側當日漲跌方向相反——兩者講的是多空結構與今日走勢，
  卻共用紅綠箭頭（36 檔自選股實測 13 檔矛盾）。趨勢改中性文字標籤
