...
echo ""
echo "     🚨 別漏 manifest——它記著兩支 JSON 的 sha256,對不上時 OTA 會"
echo "     hash mismatch 直接跳過更新(無錯誤、無日誌):"
echo "     mv assets/calibration_manifest_candidate.json \\"
echo "        assets/calibration_manifest.json"
echo ""
echo "  4. Smoke test："
echo "     flutter run"
